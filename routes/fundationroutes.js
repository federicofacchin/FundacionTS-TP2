...
import FundationController from "../Controllers/FundationController.js";

const fundationController = new FundationController();

fundationRoutes.get("/",fundationController.getAllFundations);
fundationRoutes.get("/:id",fundationController.getFundationById);
fundationRoutes.post("/", fundationController.createFundation);
fundationRoutes.put("/:id",fundationController.modifyFundation);
fundationRoutes.delete("/:id",fundationController.deleteFundation);
